...
async def main():
    ...
    makeEgg = asyncio.create_task(FryEggs(2))
    makeBacon = asyncio.create_task(FryBacon())
    makeToast = asyncio.create_task(ToastBread(2))

    tasks = [makeEgg, makeBacon, makeToast]
